...
class LancerDeuxiemeDefit : AppCompatActivity() {
    lateinit var newArray : IntArray
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lancer_deuxieme_defit)
    ...
    fun Imagebuttononclicked(view: View) {
        for (i in 0 until newArray.size) {
            if(view.getId() == newArray[i]){
                ...
                val intent = Intent(this,calculeDeuxiemeDefit::class.java)
